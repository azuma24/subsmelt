  ...
  return (
    ...
    >
      ...
      <div className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-3">
        ...
        <button onClick={onConfirm} className="rounded-lg bg-[var(--accent)] px-3 py-2 text-sm font-medium text-[var(--on-accent)] sm:col-span-1">{t("dashboard.scanConfirm.proceed")}</button>
      </div>
    </ModalShell>
  );
}
